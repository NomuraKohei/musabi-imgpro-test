import { Html, Merged, Stage, useGLTF, useProgress, useTexture } from '@react-three/drei'
import { Canvas, useFrame, useLoader } from '@react-three/fiber'
import React, { Suspense, useCallback, useEffect, useMemo, useRef, useState } from 'react'
import THREE, { Mesh, TextureLoader } from 'three'
import { GLTFExporter } from 'three/examples/jsm/exporters/GLTFExporter'
import { GLTFLoader } from 'three/examples/jsm/loaders/GLTFLoader'
import img from '../../public/24647700_s.jpg'
...
const Three: React.FC<ThreeProps> = (props) => {
  ...
  function Loader() {
    ...
    return <Html center>{`Please wait...(${progress}%/100%)`}</Html>
  }
